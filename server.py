...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def aggregate_fit(
        ...
        weights_results = [
            (parameters_to_ndarrays_custom(fit_res.parameters,
             self.context_client), fit_res.num_examples)
...
strategy = FedCustom(
    ...
    # Sample frac_eval % of available clients for evaluation
    ...
    on_fit_config_fn=get_on_fit_config_fn(
        epoch=args.max_epochs, lr=args.lr, batch_size=args.batch_size),  # Pass the fit_config function
